...
public class DogAgent : Agent
{
    ...
    [Header("Dog Agent Settings")]
    public float moveSpeed = 1f;
    public float rotateSpeed = 2f;
    public float nostrilWidth = .5f;

    private DogAcademy agentAcademy;
    private DogArea agentArea;
    ...
    public override void AgentAction(float[] vectorAction, string textAction)
    {
        ...
        else if (treatsCollected >= agentArea.GetSmellyObjects().Count)
        {
    ...
    private Vector2 GetNostrilStereo()
    {
        ...
        foreach (GameObject smellyObject in smellyObjects)
        {
            ...
            {
                leftNostril += Mathf.Log10(Vector3.Distance(smellyObject.transform.position, leftNostrilPosition));
                rightNostril += Mathf.Log10(Vector3.Distance(smellyObject.transform.position, rightNostrilPosition));
            }
        }
